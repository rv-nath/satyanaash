...
mod tests {
    ...
    */
    ...
    fn test_random_company_substitution() {
        let input =
            "Company 1: $RandomCompany, Company 2: $RandomCompany, Company 3: $RandomCompany.";
        let output = substitute_keywords(input);
    ...
    fn test_random_address_substitution() {
        let input =
            "Address 1: $RandomAddress, Address 2: $RandomAddress, Address 3: $RandomAddress.";
        let output = substitute_keywords(input);
